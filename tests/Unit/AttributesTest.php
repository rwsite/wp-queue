...
describe('Schedule Attribute', function () {
    it('can be read from class', function () {
    ...
    it('supports setting-based interval', function () {
...
describe('Queue Attribute', function () {
    it('can be read from class', function () {
        $reflection = new ReflectionClass(AttributedJob::class);
...
describe('Retries Attribute', function () {
    it('can be read from class', function () {
        $reflection = new ReflectionClass(AttributedJob::class);
...
describe('UniqueJob Attribute', function () {
    it('can be read from class', function () {
        $reflection = new ReflectionClass(AttributedJob::class);
